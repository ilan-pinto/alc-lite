...
- VixRegime: VIX regime classification for market analysis

Usage:
    from backtesting.sfr_backtest_engine import SFRBacktestEngine, SFRBacktestConfig
    from backtesting.sfr_backtest_engine import SlippageModel, VixRegime
"""
...
__all__ = ["SFRBacktestEngine", "SFRBacktestConfig", "SlippageModel", "VixRegime"]
